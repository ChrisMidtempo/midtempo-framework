...
- You MUST NOT run `test_coverage` or coverage variants at any point — tests are expected to fail and coverage is invalid in RED state
...
Run only the commands listed — do not add `test_coverage` or coverage variants.
